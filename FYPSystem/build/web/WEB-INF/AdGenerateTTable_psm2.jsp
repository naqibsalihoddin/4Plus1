...
String query="SELECT free_period,b.lectName, a.staffNo "+
             ...
             "order by lectName ";
String quotaQuery = "select ev1_psm2 as ev1, ev2_psm2 as ev2 from quota_lecturer where semester='"+semester+"'"; 
...
int q_row=0;
 if ((!(UserSession==null))&&(UserType.equals("3"))){
     ...
     objDB.query("SELECT * FROM lec_ev_timetable_psm2 where semester='"+Semester.getSemester()+"'");
...
<html>
  ...
  <div class="panel-body alert-warning">
                    ...
                    <div id="itemButton" class="hide">
                       <div class="btn btn-success" onclick="saveTimeTable('psm2')">&emsp;Save&emsp;</div>                       
                    </div>
                    </center>
                    </form>
