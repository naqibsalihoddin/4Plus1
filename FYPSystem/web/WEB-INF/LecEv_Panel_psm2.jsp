...
String color ="#fff0f5";
 ...
 if ((!(UserSession==null))&&(UserType.equals("2"))) {
     ...
     String psm2URL="";
     objDB.connect();
     objDB.query("select  f.studName, f.metricNo, g.proTitle, h.total as marks_psm2 "+
                ...
                "inner join psm_2 i on i.metricNo=f.metricNo "+
                "left outer join ev_penilaian_psm2 h on h.metricNo=b.metricNo "+
                "where a.ev1='"+UserSession+"'and i.semester='"+Semester.getSemester()+"' "+
                "order by h.total, f.studName ");
     ...
     for(int i=0;i<row;i++)
         {
          ...
          marks_ev1_psm2.add(objDB.getDataAt(i, "marks_psm2"));
        }
  objDB.close();
%>
<html>
    ...
    <body>
      ...
      <div id="Wrapper">
         ...
         <div id="BodyContent">
                <span>
                    <form>
                        <h2>Main Assessor (Panel) PSM2</h2>
                    <table id="expertise">
                        ...
                        <% if(!(row==0)){
                            for(int i=0;i<row;i++){
                                ...
                                <tr>
                                    ...
                                    <img src="<%=psm2URL%>" onclick="panelEvaluation_psm2('<%=metricNo.get(i)%>')"title="Evaluation Form" alt="Evaluation Form" ></img>
                                    </td>
                                </tr>
                        <%  }
                          }%>
