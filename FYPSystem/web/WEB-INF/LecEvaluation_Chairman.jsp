<%-- 
    Document   : LecEvaluation_Chairman
    Created on : Mar 20, 2009, 11:57:41 PM
    Author     : rou
--%>
...
float soal_jawab_m = -1;
 ...
 if ((!(UserSession==null))&&(UserType.equals("2"))) {
     ...
     objDB.query("select proTitle, b.studName, c.peradaban, c.persiapan,"+
                ...
                "left outer join ev_pembentangan_psm1 c on c.metricNo=a.metricNo "+
         ...
         <div id="BodyContent">
                <span>
                     ...
                     <fieldset id="titleSuggestion">
                        ...
                        <center>
                            ...
                            <table style="text-align:left">
                                ...
                                <tr bgcolor="#ffb6c1">
                                    <td>4.</td>
                                    <td>Kefahaman mengenai projek(5%)</td>
                    ...
                    <div id="itemButton">
                            ...
                            <div class="button" onmouseover="this.className='buttonHover'" onmouseout="this.className='button'"onclick="save('psm1')">Submit</div>                       
                    </div>
                    <%} else {%>
                    ...
                    <div id="itemSaveChanges" class="saveChangesHide">
                        <div id="itemButton">
                             <div class="button" onmouseover="this.className='buttonHover'" onmouseout="this.className='button'"onclick="save('psm1_Edit')">Save Changes</div>                       
                        </div>
                    </div>
                    <%}%>
